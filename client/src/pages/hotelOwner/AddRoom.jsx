...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title title='Add Room' font={'outfit'}  subTitle={'Fill in the details carefullt and accurate room details, pricing and amenities, to enhance the user booking experience'} align={'left'} />

        {/* Upload Area from the images */}
        ...
        <div className="flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm">
            {Object.keys(inputs.amenities).map((amenity, index) => (
                <div key={index}>
                    ...
                    <label className="ml-1" htmlFor={`amenities${index+1}`}>
                        {amenity}
                    </label>
                </div>
            ))}
